...
- Required artifact: `singularity/work-items/ashok-filter/artifacts/specification/spec.md`
...
- <requirement>. *(S1)* [ashok-filter:REQ-001]
- <requirement>. *(S1, S2)* [ashok-filter:REQ-002]

Acceptance criteria use the same stable, namespaced form:

- <observable acceptance outcome>. *(S1)* [ashok-filter:AC-001]
...
Use governed requirement anchors here too (for example `[ashok-filter:REQ-003]`); `NFR-001` by
