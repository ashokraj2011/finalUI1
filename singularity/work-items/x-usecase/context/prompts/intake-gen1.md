...
- Work-item directory: `singularity/work-items/x-usecase`
- Required artifact: `singularity/work-items/x-usecase/artifacts/intake/intake.md`
...
|---|---|
| [x-usecase:AC-001] | TODO: State one observable, testable outcome. |
...
|---|---|---|
| `x-usecase:AC-001` | TODO: `src/example.js` | TODO: `test/example.test.js` |
...
- Immutable source: `singularity/work-items/x-usecase/source.json`
- SHA-256: `8cffd50361a081dc7a66dd93a70270b2481b738f0bc4b1d7218371b1c4528010`
...
```json
{
  ...
  "id": "x-usecase",
  "title": "xchange",
  "description": "This is to be implemented in UI layer ( in Rules->Visual designer   before term1,Dont add in \"Functions Library\")\nAdd a filter block in rule visual designer page. .It is very similar to the filters in functions .this will just like terms in the visual designer page with filter and selection criteria ,fist,last etc \n.The filter can order the records using some attributes and select ast,first or range rows",
